...
# Endpoints to get all the tables in the database
@router.get("/tables", name="Get all tables in the database")
async def get_all_tables(db_session: SessionLocal = Depends(Database().get_db)):
