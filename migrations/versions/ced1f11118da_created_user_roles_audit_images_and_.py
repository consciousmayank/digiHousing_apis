"""Created user, roles, audit, images, and notes tables

Revision ID: ced1f11118da
Revises: 
Create Date: 2024-08-10 20:07:08.409281
...
def upgrade() -> None:
    ...
    op.create_table('query_amenities',
    ...
    op.execute(
        ...
        "('superAdmin', 'Super Administrative role', now(), now()), "
        "('endUser', 'End User role', now(), now()), "
        "('guest_user', 'Guest User role', now(), now()"
        ")"
